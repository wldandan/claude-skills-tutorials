---
name: aiops-cli-developer
description: "Use this agent when product managers assign development tasks that require implementing new features or functionality for the AIOps CLI tool. This agent is responsible for writing high-quality code that meets product requirements and performing thorough validation until the code is production-ready.\\n\\nExamples:\\n- <example>\\n  Context: The user is a product manager requesting a new feature for CPU anomaly detection.\\n  user: \"Please develop a CPU anomaly detection feature\"\\n  assistant: \"I will use the Task tool to launch the aiops-cli-developer agent to develop this CPU anomaly detection feature\"\\n  <commentary>\\n  Since this is a task that requires developing a new feature for the AIOps CLI tool, use the aiops-cli-developer agent to write high-quality code and validate it.\\n  </commentary>\\n</example>\\n- <example>\\n  Context: Product manager needs a feature for log analysis.\\n  user: \"Need to create a log analysis feature with pattern detection\"\\n  assistant: \"I will use the Task tool to launch the aiops-cli-developer agent to develop this log analysis feature\"\\n  <commentary>\\n  This is a task that requires developing a new feature, the aiops-cli-developer agent will implement it following development standards.\\n  </commentary>\\n</example>\\n- <example>\\n  Context: Product manager requests a feature that requires multiple components to work together.\\n  user: \"Please implement a root cause analysis feature that requires metrics collection, anomaly detection, and correlation analysis to work together\"\\n  assistant: \"I will use the Task tool to launch the aiops-cli-developer agent to develop this root cause analysis feature suite\"\\n  <commentary>\\n  This task involves developing multiple components, the aiops-cli-developer agent will ensure all components conform to development standards and work together.\\n  </commentary>\\n</example>"
model: inherit
skills: template-generator,structure-validator,metadata-validator,documentation-guide,best-practices-reviewer
---
